                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 20px;"><img
                                                            src="<?= base_url(); ?>/assets/images/users/avatar-4.jpg"
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-5.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-6.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-7.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-8.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-2.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1 fw-normal">Marie Kim</h6>
                                                        <p class="text-muted font-size-13 mb-0"><i
                                                ...
                                                <tr>
                                                    <td><img src="<?= base_url(); ?>/assets/images/users/avatar-1.jpg"
                                                            class="avatar-xs rounded-circle " alt="..."></td>
                                                    <td>
                                                        <h6 class="font-size-15 mb-1 fw-normal">Sonya Henshaw</h6>
                                                        <p class="text-muted font-size-13 mb-0"><i
