        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    switch ($lang) {
                        case 'en':
                            echo '<img src="<?= base_url(); ?>/assets/images/flags/us.jpg" alt="Header Language"
                    height="16">';
                    break;
                    case 'es':
                    echo '<img src="<?= base_url(); ?>/assets/images/flags/spain.jpg" alt="Header Language"
                        height="16">';
                    break;
                    case 'de':
                    echo '<img src="<?= base_url(); ?>/assets/images/flags/germany.jpg" alt="Header Language"
                        height="16">';
                    break;
                    case 'it':
                    echo '<img src="<?= base_url(); ?>/assets/images/flags/italy.jpg" alt="Header Language"
                        height="16">';
                    break;
                    case 'ru':
                    echo '<img src="<?= base_url(); ?>/assets/images/flags/russia.jpg" alt="Header Language"
                        height="16">';
                    break;
                    default:
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1"><?= lang('Files.If several languages coalesce the grammar') ?>
                                        </p>
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <?= lang('Files.3 min ago') ?></p>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="font-size-12 text-muted">
                                        <p class="mb-1">
                                            <?= lang('Files.As a skeptical Cambridge friend of mine occidental') ?></p>
                                        <p class="mb-0"><i class="mdi mdi-clock-outline"></i>
                                            <?= lang('Files.1 hours ago') ?></p>
                                    </div>
                                </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="<?= base_url(); ?>/assets/images/users/avatar-4.jpg" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item d-block" href="#"><i
                            ...
                            class="align-middle"><?= lang('Files.Settings') ?></span> <span
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                                <i class="uil-flask me-2"></i><?= lang('Files.UI Elements') ?> <div class="arrow-down">
                                </div>
                            </a>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <a href="ui-carousel"
                                                class="dropdown-item"><?= lang('Files.Carousel') ?></a>
                                            <a href="ui-dropdowns"
                                                class="dropdown-item"><?= lang('Files.Dropdowns') ?></a>
                                    ...
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="ui-lightbox"
                                                class="dropdown-item"><?= lang('Files.Lightbox') ?></a>
                                            <a href="ui-modals" class="dropdown-item"><?= lang('Files.Modals') ?></a>
                                            <a href="ui-rangeslider"
                                                class="dropdown-item"><?= lang('Files.Range Slider') ?></a>
                                            <a href="ui-session-timeout"
                                                class="dropdown-item"><?= lang('Files.Session Timeout') ?></a>
                                            <a href="ui-progressbars"
                                                class="dropdown-item"><?= lang('Files.Progress Bars') ?></a>
                                            <a href="ui-sweet-alert"
                                                class="dropdown-item"><?= lang('Files.Sweet-Alert') ?></a>
                                            <a href="ui-tabs-accordions"
                                                class="dropdown-item"><?= lang('Files.Tabs & Accordions') ?></a>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div>
                                            <a href="ui-typography"
                                                class="dropdown-item"><?= lang('Files.Typography') ?></a>
                                            ...
                                            <a href="ui-notifications"
                                                class="dropdown-item"><?= lang('Files.Notifications') ?></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                        <a href="invoices-list"
                                            class="dropdown-item"><?= lang('Files.Invoice List') ?></a>
                                        <a href="invoices-detail"
                                            class="dropdown-item"><?= lang('Files.Invoice Detail') ?></a>
                                    </div>
                                </div>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                        ...
                                        <a href="contacts-profile"
                                            class="dropdown-item"><?= lang('Files.Profile') ?></a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components"
                                role="button">
                                <i class="uil-layers me-2"></i><?= lang('Files.Components') ?> <div class="arrow-down">
                                </div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-components">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-form">
                                        <a href="form-elements"
                                            class="dropdown-item"><?= lang('Files.Basic Elements') ?></a>
                                        <a href="form-validation"
                                            class="dropdown-item"><?= lang('Files.Validation') ?></a>
                                        <a href="form-advanced"
                                            class="dropdown-item"><?= lang('Files.Advanced Plugins') ?></a>
                                        <a href="form-editors" class="dropdown-item"><?= lang('Files.Editors') ?></a>
                                        <a href="form-uploads"
                                            class="dropdown-item"><?= lang('Files.File Upload') ?></a>
                                        <a href="form-xeditable"
                                            class="dropdown-item"><?= lang('Files.Xeditable') ?></a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-table">
                                        <a href="tables-basic"
                                            class="dropdown-item"><?= lang('Files.Bootstrap Basic') ?></a>
                                        <a href="tables-datatable"
                                            class="dropdown-item"><?= lang('Files.Datatables') ?></a>
                                        <a href="tables-responsive"
                                            class="dropdown-item"><?= lang('Files.Responsive') ?></a>
                                        <a href="tables-editable"
                                            class="dropdown-item"><?= lang('Files.Editable') ?></a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                        ...
                                        <a href="charts-sparkline"
                                            class="dropdown-item"><?= lang('Files.Sparkline') ?></a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                        ...
                                        <a href="icons-materialdesign"
                                            class="dropdown-item"><?= lang('Files.Material Design') ?></a>
                                        <a href="icons-dripicons"
                                            class="dropdown-item"><?= lang('Files.Dripicons') ?></a>
                                        <a href="icons-fontawesome"
                                            class="dropdown-item"><?= lang('Files.Font Awesome') ?></a>
                                    </div>
                                </div>
                                <div class="dropdown">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button">
                                <i class="uil-copy me-2"></i><?= lang('Files.Extra Pages') ?> <div class="arrow-down">
                                </div>
                            </a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                        ...
                                        <a href="auth-recoverpw"
                                            class="dropdown-item"><?= lang('Files.Recover Password') ?></a>
                                        <a href="auth-lock-screen"
                                            class="dropdown-item"><?= lang('Files.Lock Screen') ?></a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                        <a href="pages-starter"
                                            class="dropdown-item"><?= lang('Files.Starter Page') ?></a>
                                        <a href="pages-maintenance"
                                            class="dropdown-item"><?= lang('Files.Maintenance') ?></a>
                                        <a href="pages-comingsoon"
                                            class="dropdown-item"><?= lang('Files.Coming Soon') ?></a>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-layout" role="button">
                                <i class="uil-window-section me-2"></i><?= lang('Files.Layouts') ?> <div
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layout-verti">
                                        <a href="layouts-dark-sidebar"
                                            class="dropdown-item"><?= lang('Files.Dark Sidebar') ?></a>
                                        <a href="layouts-compact-sidebar"
                                            class="dropdown-item"><?= lang('Files.Compact Sidebar') ?></a>
                                        <a href="layouts-icon-sidebar"
                                            class="dropdown-item"><?= lang('Files.Icon Sidebar') ?></a>
                                        <a href="layouts-boxed"
                                            class="dropdown-item"><?= lang('Files.Boxed Width') ?></a>
                                        <a href="layouts-preloader"
                                            class="dropdown-item"><?= lang('Files.Preloader') ?></a>
                                        <a href="layouts-colored-sidebar"
                                            class="dropdown-item"><?= lang('Files.Colored Sidebar') ?></a>
                                    </div>
                                </div>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-layout-hori">
                                        ...
                                        <a href="layouts-hori-topbar-dark"
                                            class="dropdown-item"><?= lang('Files.Dark Topbar') ?></a>
