...
<div id="layout-wrapper">
    ...
    <div class="main-content">
                        ...
                        <div class="card">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Form master years
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <div class="form-group c_form_group">
                                                    <label>Tahun</label>
                                                    <input type="text" class="form-control email" id="Tahun" name=""
                                                        placeholder="Tahun">
                                                </div>
                                                <label class="col-md-12 col-form-label">Semeter</label>
                                                <div class="col-md-12">
                            ...
                            <div class="modal fade editmodal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Update School Year
                                            </h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close">
                                            </button>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="form-group c_form_group">
                                                    <label class="col-md-12 col-form-label">Tahun dan Semester</label>
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="tahun-semester"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group c_form_group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select name="col-form-label" class="form-select"
                                                            id="status-year">
        ...
        function ambil_data() {
            ...
            $.ajax({
                url: "<?= route_to('admin/master-years-datatable') ?>",
                headers: {
                ...
                success: function(data) {
                    ...
                    if (data.responce == "success") {
                        $("#datatable").DataTable({
                            ...
                            "language": {
                                "emptyTable": "Tidak ada data tahun"
                            },
                            "buttons": [{
                                    extend: 'copy',
        ...
        $(document).on('click', '#button-entri', function(e) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/add-master-years') ?>",
                type: "POST",
                data: data,
                // global: false,
                // async: false,
                ...
                success: function(data) {
                    ...
                    if (data.tahun != undefined) {
                        toastr.error(data.tahun);
                    } else if (data.semester != undefined) {
                        toastr.error(data.semester);
        ...
        $(document).on('click', '#button-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    // console.log(data);
                    $.ajax({
                        url: "<?= route_to('admin/remove-master-years') ?>",
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        },
                        data: data,
        ...
        $(document).on('click', '#editmodal', function(e) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/detail-master-years') ?>",
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
                data: data,
                ...
                success: function(data) {
                    // console.log(data);
                    $('input[name=csrf_token_name]').val(data.csrf_token_name);
                    $('#tahun-semester').val(data.tahun + ' ' +
                        data.semester);
                    $('#status-year').val(data.status);
                    $('#id').val(data.id);
                }
            });
        });
        ...
        $(document).on('click', '#button-update', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= route_to('admin/update-master-years') ?>",
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        },
                        data: data,
