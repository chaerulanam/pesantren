                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">Keperluan</label>
                                                        <input type="text" class="form-control" id="Keperluan-Edit"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
...
function ambil_data() {
    ...
    $.ajax({
        url: "<?= route_to('admin/data-permission-datatable') ?>",
        headers: {
...
$(document).on('click', '#button-entri', function(e) {
    ...
    // console.log(data);
    $.ajax({
        url: "<?= route_to('admin/add-data-permission') ?>",
        type: "POST",
        data: data,
        // global: false,
        // async: false,
...
$(document).on('click', '#button-delete', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/remove-data-permission') ?>",
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
                data: data,
...
$(document).on('click', '#edit', function(e) {
    ...
    $.ajax({
        url: "<?= route_to('admin/detail-data-permission') ?>",
        type: "GET",
        data: data,
        success: function(data) {
            // console.log(data);
            ...
            $('#Keperluan-Edit').val(data.keperluan);
            $('#id').val(data.id);
...
$(document).on('click', '#button-update', function(e) {
    ...
    // console.log(data);
    $.ajax({
        url: "<?= route_to('admin/update-data-permission') ?>",
        type: "POST",
        data: data,
        // global: false,
        // async: false,
