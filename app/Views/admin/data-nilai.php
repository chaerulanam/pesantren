                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <label for="tahun">Filter Tahun Ajaran dan Semester</label>
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <select id="nama_lengkap" class="form-control select2" onchange="ambil_data();">
                                        </select>
                                    </div>
                                </div>
                            </div>
...
function ambil_data() {
    ...
    console.log(data);
    $.ajax({
        url: "<?= route_to('admin/data-values-datatable') ?>",
        headers: {
...
function ambil_data_rangking() {
    ...
    console.log(data);
    $.ajax({
        url: "<?= route_to('admin/data-values-ranks-datatable') ?>",
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        },
        data: data,
...
function getmapel() {
    ...
    $.ajax({
        url: "<?= route_to('admin/mapel-data-values') ?>",
        headers: {
            'X-Requested-With': 'XMLHttpRequest'
        },
        data: {
...
$(document).on('click', '#button-update', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/update-data-values') ?>",
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
                data: data,
