                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="Nama-Pengunjung">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="Nama-Pengunjung-Edit" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
...
function ambil_data() {
    ...
    $.ajax({
        url: "<?= route_to('admin/data-visitation-datatable') ?>",
        headers: {
...
$(document).on('click', '#button-entri', function(e) {
    var data = {
        ...
        'nama_pengunjung': $('#Nama-Pengunjung').val(),
    }

    // console.log(data);
    $.ajax({
        url: "<?= route_to('admin/add-data-visitation') ?>",
        type: "POST",
        data: data,
        // global: false,
        // async: false,
        ...
        success: function(data) {
            ...
            } else if (data.nama_pengunjung != undefined) {
                toastr.error(data.nama_pengunjung);
...
$(document).on('click', '#button-delete', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/remove-data-visitation') ?>",
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                },
                data: data,
...
$(document).on('click', '#edit', function(e) {
    ...
    $.ajax({
        url: "<?= route_to('admin/detail-data-visitation') ?>",
        type: "GET",
        data: data,
        success: function(data) {
            // console.log(data);
            ...
            $('#Nama-Pengunjung-Edit').val(data.nama_pengunjung);
            $('#id').val(data.id);
...
$(document).on('click', '#button-update', function(e) {
    ...
    // console.log(data);
    $.ajax({
        url: "<?= route_to('admin/update-data-visitation') ?>",
        type: "POST",
        data: data,
        // global: false,
        // async: false,
