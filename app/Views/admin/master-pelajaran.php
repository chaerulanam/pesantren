...
<div id="layout-wrapper">
    ...
    <div class="main-content">
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Form master lessons
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <div class="form-group c_form_group">
                                                    ...
                                                    <input type="text" class="form-control email" id="Pelajaran" name=""
        ...
        function ambil_data() {
            ...
            $.ajax({
                url: "<?= route_to('admin/master-lessons-datatable') ?>",
                headers: {
                ...
                success: function(data) {
                    ...
                    if (data.responce == "success") {
                        $("#datatable").DataTable({
                            ...
                            "language": {
                                "emptyTable": "Tidak ada data Pelajaran"
                            },
                            "buttons": [{
                                    extend: 'copy',
        ...
        $(document).on('click', '#button-entri', function(e) {
            ...
            // console.log(data);
            $.ajax({
                url: "<?= route_to('admin/add-master-lessons') ?>",
                type: "POST",
                data: data,
                // global: false,
                // async: false,
                ...
                success: function(data) {
                    // console.log(data);
                    $('input[name=csrf_token_name]').val(data.csrf_token_name);
                    if (data.pelajaran != undefined) {
                        toastr.error(data.pelajaran);
        ...
        $(document).on('click', '#button-delete', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= route_to('admin/remove-master-lessons') ?>",
                        headers: {
                            'X-Requested-With': 'XMLHttpRequest'
                        },
                        data: data,
