...
class DataValues extends BaseController
{
    ...
    public function index()
    {
        $data = [
            ...
            'title_meta' => view('admin/partials/title-meta', ['title' => 'Data Values and Ranks', 'sitename' => $this->opsiModel->getopsi('sitename'),]),
            'page_title' => view('admin/partials/page-title', ['title' => 'Data Values and Ranks', 'pagetitle' => $this->opsiModel->getopsi('sitename'),])
        ];
        // dd($data);
